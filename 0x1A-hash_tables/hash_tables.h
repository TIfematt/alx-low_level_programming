 ...
 * Each cell of this array is a pointer to the first node of a linked list,
 * because we want out HashTable to use a chaining collission handling
 */
...
/* 1-djb2.c */
unsigned long int hash_djb2(const unsigned int char *str);
...
char *shash_table_get(const shash_table *ht, const char *key);
